...
%
%   FUNCTIONS:
%       - fem_kquad4 - creates the elemental stiffness matrix of a
%                      quadrilateral isoparametric element for the
%                      mechanical static analysis
%       - bmatrixquad - computes the B matrix for the quadrilateral
%                       element
%
%
% **************************************************************************
...
function [kel] = fem_kquad4( ndofel, thck, ngpt, xgp, wgp, ndim, nnodel, xel, D, nstr )
